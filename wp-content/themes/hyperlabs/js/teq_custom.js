...
jQuery(document).ready(function($) {
    ...
    $(document).on('click','#secound_payment_enter', function(e){
      ...
      var billing_backyard   = $('#billing_backyard').val();
      ...
      if(billing_address_1 == ""){
        isValid = false;
        $('#billing_address_1').after('<span class="custom_error" style="color:red">Mandatory field for filling</span>');
      }
      if(billing_phone == ""){
        isValid = false;
      ...
      if(billing_backyard == ""){
        isValid = false;
        $('select#billing_backyard').after('<span style="color:red" class="custom_error" >Mandatory field for filling</span>');
      }
        if(isValid == false){
             e.preventDefault();
          //  $(this).css('pointer-events','none');
           ...
           // $(this).css('pointer-events','');
            ...
            $('#save_address').html(billing_address_1);
