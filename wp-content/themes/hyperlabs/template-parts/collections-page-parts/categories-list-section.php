...
$collectionsCategoriesList = get_field('collections_categories_repeater');
?>

<?php if ($collectionsCategoriesList): ?>
	<div class="hl__double-screen row gx-0">
		<?php foreach ($collectionsCategoriesList as $index => $item):
			...
			// Данные продукта
			$product_id = $item['collections_category_product_preview'];
